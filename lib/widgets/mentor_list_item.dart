import 'package:FlutterGalleryApp/models/mentor.dart';
import 'package:flutter/material.dart';

class MentorListItem extends StatelessWidget {
  final Mentor mentor;

  const MentorListItem(this.mentor);
  ...
  Widget build(BuildContext context) {
    ...
    final info = Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: <BoxShadow>[
          BoxShadow(
              color: Colors.black54, blurRadius: 5.0, offset: Offset(0.0, 10.0))
        ],
      ),
      child: Container(
